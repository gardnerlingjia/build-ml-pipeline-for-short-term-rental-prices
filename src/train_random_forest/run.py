...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Random forest pipeline exported with MLflow",
        metadata=rf_config
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # ColumnTransformer instance that wesaved in the `preprocessor` variable, and a step called "random_forest"
